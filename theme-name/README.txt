...
*   "Contributors" is a comma separated list of wp.org/wp-themes.org usernames
...
1. Upload `theme-name.php` to the `/wp-content/themes/` directory
1. Activate the theme through the 'Themes' menu in WordPress
1. Place `<?php do_action('theme_name_hook'); ?>` in your templates
