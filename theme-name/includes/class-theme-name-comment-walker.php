 ...
 *
 * This class defines all code necessary to display custom comment walker.
 * ```
 *<ol class="comment-list">
 *   <?php
 *   wp_list_comments(
 *       array(
 *           'walker'      => new Theme_Name_Walker_Comment(),
...
if ( ! class_exists( 'Theme_Name_Walker_Comment' ) ) :

class Theme_Name_Walker_Comment extends Walker_Comment {
